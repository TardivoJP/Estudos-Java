...
public class FuncionarioCheckpoint {
	private String nome;
	private Nivel nivel;
	...
	public FuncionarioCheckpoint() {
		
	}

	public FuncionarioCheckpoint(String nome, Nivel nivel, double salarioBase, Departamento departamento) {
		this.nome = nome;
		this.nivel = nivel;
